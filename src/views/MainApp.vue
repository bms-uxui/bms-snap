    ...
    <div>
      ...
      <div class="max-w-full mx-auto px-8 md:px-16 lg:px-[240px]">
        ...
        <div class="action-cards-row">
          ...
          <!-- Insights Card -->
          <div class="action-card action-card-green" @click="router.push({ name: 'insights' })">
            <div class="action-card-content">
              <span class="action-card-badge action-card-badge-green">
              ...
              <p class="action-card-desc">ดูสถิติโครงการรายสัปดาห์/เดือน</p>
            </div>
            <div class="insights-card-decor">
              <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
                <rect x="10" y="50" width="14" height="24" rx="3" fill="#a7f3d0" />
                <rect x="30" y="38" width="14" height="36" rx="3" fill="#6ee7b7" />
                <rect x="50" y="22" width="14" height="52" rx="3" fill="#34d399" />
                <rect x="70" y="30" width="14" height="44" rx="3" fill="#10b981" />
                <rect x="90" y="14" width="14" height="60" rx="3" fill="#059669" />
              </svg>
            </div>
          </div>
        </div>
